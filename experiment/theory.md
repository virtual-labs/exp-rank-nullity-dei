...
(iii). Let <i>A</i>= </span> $ \begin{pmatrix}a & b \\\ c & d\end{pmatrix}, where a, b, c, d are non-zero real numbers and ad-bc≠0, be a matrix of order 2×2. Then nullity of <i>A</i> is 0 because its the null space is {(0, 0)}. <br>
...
<span style="font-family: 'Times New Roman'; font-size: 22px;">, where a, b, c, d are non-zero real numbers and ad-bc≠0, be a matrix of order 2×2. Then the rank of A is 2. <br>
