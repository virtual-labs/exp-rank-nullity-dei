...
(v). Let <i>A</i>=, where <i>a, b</i> are non-zero real numbers, be a matrix of order 2×2. Then nullity of <i>A</i> is two because its null space is {(<i>a, b</i>): <i>a, b</i>&isin;<i>R</i>}. </span><br>
